<?php if ($customer_chat === false) : ?>
    ...
    <form action="<?php echo erLhcoreClassDesign::baseurl('lhccustomer/searchcustomer')?>/<?php echo $chat->id?>" method="post" onsubmit="return lhcCustomer.doSearch($(this),<?php echo $chat->id?>)" ng-non-bindable>
        <div class="row">
            <div class="col-xs-6">
